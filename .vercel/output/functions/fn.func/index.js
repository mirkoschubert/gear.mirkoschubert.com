...
var Header, Navigation, Layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    init_chunks();
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<header class="header"><div class="overlay"><a href="/" title="Gear"><p class="title">GEAR</p></a>
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/entry/error.svelte.efedd79f.js";
    imports2 = ["_app/immutable/entry/error.svelte.efedd79f.js", "_app/immutable/chunks/index.22788120.js", "_app/immutable/chunks/singletons.abf8f6d2.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
  ...
  ".svelte-kit/output/server/chunks/Section.js"() {
    ...
    Section = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.id === void 0 && $$bindings.id && id !== void 0)
        $$bindings.id(id);
      return `<section${add_attribute("id", id, 0)} class="section">${slots.default ? slots.default({}) : ``}</section>`;
    });
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${$$result.head += `<!-- HEAD_svelte-6now0q_START -->${$$result.title = `<title>Home \u2013 Mirko Schubert Gear</title>`, ""}<!-- HEAD_svelte-6now0q_END -->`, ""}

<main>${validate_component(Section, "Section").$$render($$result, {}, {}, {
        default: () => {
          return `<h2>Welcome to SvelteKit</h2>
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/entry/_page.svelte.77853f65.js";
    imports3 = ["_app/immutable/entry/_page.svelte.77853f65.js", "_app/immutable/chunks/index.22788120.js", "_app/immutable/chunks/Section.bf24981b.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file4 = "_app/immutable/entry/about-page.svelte.cb45ea2e.js";
    imports4 = ["_app/immutable/entry/about-page.svelte.cb45ea2e.js", "_app/immutable/chunks/index.22788120.js", "_app/immutable/chunks/Section.bf24981b.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/essentials/_page.server.ts.js
...
var init_ProductListMeta = __esm({
  ...
  <a class="overlay"${add_attribute("href", data.url, 0)}${add_attribute("title", data.name, 0)} rel="noreferrer noopener" target="_blank"${add_attribute("aria-disabled", data.url === "", 0)}><h3 class="product-title">${escape(data.name)}</h3>
      ...
      <div class="details">${data.weight ? `<div class="weight">${escape(data.weight)}g</div>` : ``}
        ${data.price ? `<div class="price">${escape(data.price.toFixed(2))}\u20AC</div>` : ``}
        ${data.size && data.size.width !== 0 && data.size.height !== 0 ? `<div class="size">${escape(data.size.width)}x${escape(data.size.height)}${data.size.depth && data.size.depth !== 0 ? `x${escape(data.size.depth)}` : ``}cm</div>` : ``}</div></a></div>`;
    });
    ProductList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { data } = $$props;
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      return `<div class="product-list">${each(data, (item) => {
        return `${validate_component(Product, "Product").$$render($$result, { data: item }, {}, {})}`;
      })}</div>`;
    });
    ProductListMeta = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { title } = $$props;
      let { data } = $$props;
      ...
      return `<div class="products-meta"><h1>${escape(title)} <span class="count">(${escape(count)})</span></h1>
...
var init_page_svelte3 = __esm({
  ".svelte-kit/output/server/entries/pages/essentials/_page.svelte.js"() {
    ...
    Page3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<main>${validate_component(Section, "Section").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(ProductListMeta, "ProductListMeta").$$render(
            $$result,
            {
              title: "Essentials",
    ...
    ${validate_component(ProductList, "ProductList").$$render($$result, { data: data.essentials }, {}, {})}`;
        }
      })}</main>`;
    });
  }
...
var index5, component5, file5, server_id, imports5, stylesheets5, fonts5;
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    init_page_server_ts();
    index5 = 4;
...
var manifest = {
  ...
  _: {
    client: { "start": { "file": "_app/immutable/entry/start.d32daf31.js", "imports": ["_app/immutable/entry/start.d32daf31.js", "_app/immutable/chunks/index.22788120.js", "_app/immutable/chunks/singletons.abf8f6d2.js"], "stylesheets": [], "fonts": [] }, "app": { "file": "_app/immutable/entry/app.27600f35.js", "imports": ["_app/immutable/entry/app.27600f35.js", "_app/immutable/chunks/index.22788120.js"], "stylesheets": [], "fonts": [] } },
    nodes: [
